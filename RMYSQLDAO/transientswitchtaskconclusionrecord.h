...
public:
    ...
    float recloseConclusion() const;
    float breakerConclusion() const;
    ...
    int reclosingResult() const;
    int breakerResult() const;
...
public:
    ...
    void setRecloseConclusion(const float &recloseConclusion);
    void setBreakerConclusion(const float &breakerConclusion);
    ...
    void setReclosingResult(const int &reclosingResult);
    void setBreakerResult(const int &breakerResult);
...
inline float TransientSwitchTaskConclusionRecord::recloseConclusion() const
{
    return m_recloseConclusion;
}

inline float TransientSwitchTaskConclusionRecord::breakerConclusion() const
{
    return m_breakerConclusion;
}
...
inline int TransientSwitchTaskConclusionRecord::reclosingResult() const
{
    return m_reclosingResult;
}

inline int TransientSwitchTaskConclusionRecord::breakerResult() const
{
    return m_breakerResult;
}
...
inline void TransientSwitchTaskConclusionRecord::setRecloseConclusion(const float &recloseConclusion)
{
    m_recloseConclusion = recloseConclusion;
}

inline void TransientSwitchTaskConclusionRecord::setBreakerConclusion(const float &breakerConclusion)
{
    m_breakerConclusion = breakerConclusion;
}
...
inline void TransientSwitchTaskConclusionRecord::setReclosingResult(const int &reclosingResult)
{
  m_reclosingResult = reclosingResult;
}

inline void TransientSwitchTaskConclusionRecord::setBreakerResult(const int &breakerResult)
{
