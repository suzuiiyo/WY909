...
void ReportWriter::writeReportThree()
{
    ...
    if(!fileExist()){
        ...
        for(i=writeScrelistMap.constBegin(); i!=writeScrelistMap.constEnd(); i++){
            ...
            QString result1;
            if("0" == i.value().at(0).at(2)){
                result1 = "正常";
            }else if("1" == i.value().at(0).at(2))
            {
                result1 = "异常需关注";
            }else if("2" == i.value().at(0).at(2))
            {
                result1 = "严重需检修";
            }

            QString result2;
            if("0" == i.value().at(1).at(2)){
                result2 = "正常";
            }else if("1" == i.value().at(1).at(2))
            {
                result2 = "异常需关注";
            }else if("2" == i.value().at(1).at(2))
            {
                result2 = "严重需检修";
            }
            ...
            if("0" == i.key().at(2)){
                result3 = "正常";
            }else if("1" == i.key().at(2))
            {
                result3 = "异常需关注";
            }else if("2" == i.key().at(2))
            {
                result3 = "严重需检修";
            }

            QDomElement result = doc.createElement("Result");
            QString desc1 = i.key().at(0) + " 与 " + i.value().at(0).at(0) + "比对结果:" + result1;
            QString desc2 = i.key().at(0) + " 与 " + i.value().at(1).at(0) + "比对结果:" + result2;
            QString desc3 = i.value().at(0).at(0) + "与" + i.value().at(1).at(0) + "比对结果:" + result3;
            //       if(QString::dddcompare(i.value().at(0).at(2), i.value().at(1).at(2)) == 0 &&
            //          QString::compare(i.value().at(0).at(2), i.key().at(2)) == 0 &&
            //          QString::compare(i.value().at(1).at(2), i.key().at(2)) == 0){
            //          result.setAttribute("desc", "保护装置AB套与故障录波装置本通道比对结果正常");
            //       }else{
//              result.setAttribute("desc", desc1 + ", " + desc2 + ", " + desc3);
                //不写保护比对结果
              result.setAttribute("desc", desc1 + ", " + desc2);
            //       }
...
void ReportWriter::writeReportTwo()
{
    ...
    if(!fileExist()){
        ...
        foreach(QStringList iList, resultInfo.resultSet){
            ...
            if("0" == iList.at(4)){
                resultDesc = "正常";
            }else if("1" == iList.at(4))
            {
                resultDesc = "异常需关注";
            }else if("2" == iList.at(4))
            {
                resultDesc = "严重需检修";
            }
            QDomElement result = doc.createElement("result");
            result.setAttribute("desc", resultDesc);
